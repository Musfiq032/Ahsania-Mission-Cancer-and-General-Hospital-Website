...
urlpatterns = [
                  ...
                  path('donation-list/', donation, name='donation-list'),

    ## Url For List objects filtered by their Categories

                  path('<slug:department_slug>', doctor_list_view, name='doc_by_department'),
                  path('news/<slug:cat_slag>', news_list_view, name='news_list_by_cat'),
                  path('donation-list/<slug:donation_slug>', donation , name='donation_list_by_cat'),
